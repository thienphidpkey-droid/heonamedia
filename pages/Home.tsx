...
export const Home: React.FC = () => {
  ...
  return (
    <>
          ...
          <div className="animate-slide-up relative">
            ...
            <div className="flex flex-col gap-8 mb-10">
                ...
                <div className="pl-5 border-l-4 border-primary/50 hover:border-primary transition-colors duration-300">
                    ...
                    <p className="text-textMuted text-lg mb-3 leading-relaxed">
                    ...
                    <div className="bg-white/5 p-3 rounded border border-white/5 text-white/90 italic text-sm">
                ...
                <div className="pl-5 border-l-4 border-secondary/50 hover:border-secondary transition-colors duration-300">
                    ...
                    <div className="bg-white/5 p-3 rounded border border-white/5 text-textMuted text-sm italic">
      ...
      <Section narrow className="py-16 bg-gradient-to-b from-[#0b0b0d] to-[#08080a]">
        <div className="text-center mb-12">
